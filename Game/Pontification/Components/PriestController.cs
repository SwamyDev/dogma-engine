...
namespace Pontification.Components
{
    public class PriestController : Component, IController
    {
        ...
        public override void Start()
        {
            ...
            _behaviourTree = new PriestTree(this);
