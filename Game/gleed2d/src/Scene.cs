...
using Pont = Pontification.Components;
...
namespace GLEED2D
{
    public partial class Scene
    {
        ...
        public static Scene FromFile(string filename, ContentManager cm)
        {
            FileStream stream = File.Open(filename, FileMode.Open);
            XmlSerializer serializer = new XmlSerializer(typeof(Scene));
            Scene level = (Scene)serializer.Deserialize(stream);
            stream.Close();
    ...
    [XmlInclude(typeof(LObjectTemplate))]
    [XmlInclude(typeof(PlayerStart))]
    [XmlInclude(typeof(GuardStart))]
    [XmlInclude(typeof(PriestStart))]
    [XmlInclude(typeof(DoorItem))]
    [XmlInclude(typeof(FuseBoxItem))]
    [XmlInclude(typeof(LightEmitterItem))]
    [XmlInclude(typeof(BlockerItem))]
    
    [XmlInclude(typeof(PhysicsPath))]
    [XmlInclude(typeof(AIPath))]
    [XmlInclude(typeof(IlluminationArea))]

    [XmlInclude(typeof(LevelTransition))]
    [XmlInclude(typeof(TurretItem))]
    [XmlInclude(typeof(HolyGround))]
    [XmlInclude(typeof(Water))]
    [XmlInclude(typeof(HolySmoke))]
    ...
    public partial class GameObjectItem : Item
    {
        /// <summary>
        ...
        [DisplayName("Components"), Category(" General")]
        [XmlIgnore()]
        ...
        {
            _icon = cm.Load<Texture2D>("icon_gameobject");

            if (Components == null)
                Components = new ComponentItemCollection();

            foreach(var c in Components)
                foreach(var selectable in c.GetSelectables())
                    selectable.gameObject = this;

            Scene.GameObjectNames.Add(Name);
        ...
        public override void draw(SpriteBatch sb)
        {
            ...
            sb.Draw(_icon, Position, null, Color.White, Rotation, Vector2.Zero, Scale, SpriteEffects.None, 0);
        }
    }
    ...
    public class SerializableDictionary : Dictionary<String, CustomProperty>, IXmlSerializable
    {
        ...
        /// </summary>
        public void RestoreItemAssociations(Scene level)
        {
