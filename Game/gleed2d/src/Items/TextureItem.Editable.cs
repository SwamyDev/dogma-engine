...
namespace GLEED2D
{
    [TypeConverter(typeof(TextureItemExpandableCollectionConverter))]
    public partial class TextureItem
    {
        ...
        #region TextureItem expandable collection converter class
        internal class TextureItemExpandableCollectionConverter : ExpandableObjectConverter
        {
